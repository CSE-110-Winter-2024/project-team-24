...
public interface TaskDao {
    ...
    default int append(TaskEntity taskEntity) {
        ...
        var newTask = new TaskEntity(taskEntity.task, taskEntity.checkoff, maxSortOrder + 1);
    ...
    default int prepend(TaskEntity taskEntity) {
        ...
        var newTask = new TaskEntity(taskEntity.task, taskEntity.checkoff, getMinSortOrder() - 1);
        return Math.toIntExact(insert(newTask));
    }
